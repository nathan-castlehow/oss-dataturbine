...
public class Player {
    ...
    public static final float    DEFAULT_SAMPLE_TIME   = 5;      //SECONDS
    public static final float    DEFAULT_SAMPLE_RATE   = 44100;  //HZ
    public static final int      DEFAULT_SAMPLE_SIZE   = 16;     //BITS
    ...
    public Player(  float sampleTime, float sampleRate, int sampleSize, 
                    int numChannels, boolean signed, boolean bigEndian){
