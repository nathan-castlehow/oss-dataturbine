...
public class DataPacket {
  ...
  public void addData(Object data, Integer channel, String channelName,
      long timestamp, Vector<Long> timestampVecForChannel) {

    if(channelVec.size() != dataVec.size() || 
        timestampVec.size() != dataVec.size() || 
        channelNameVec.size() != dataVec.size() ) {
        
      throw new IllegalStateException("Data addition to the data packet is " +
          "not synchronized with the timestamp and channel addition.");
    }
