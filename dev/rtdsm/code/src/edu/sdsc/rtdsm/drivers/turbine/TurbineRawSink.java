...
public class TurbineRawSink extends TurbineClient implements DataSink {
  ...
  public TurbineRawSink (TurbineServer server, String sinkName, 
      SinkCallBackListener callbackHandler){
  ...
  public void connectNoHangup() {
    ...
    switch(sinkWrapper.getRequestMode()) {
      ...
      case TurbineSinkConfig.MONITOR_MODE:
        ...
        handler = new TurbineSinkMonitorHandler(this, 
             callbackHandler, sinkWrapper.getTimeout());
        break;

      case TurbineSinkConfig.POLL_MODE:
        this.reqPollIntervals = sinkWrapper.getPollIntervals();
        handler = new TurbineSinkPollHandler(this, 
             callbackHandler);
        break;

      default:
        throw new IllegalStateException("Only monitor mode is currently "+
            "supported. More to come soon");
    }
