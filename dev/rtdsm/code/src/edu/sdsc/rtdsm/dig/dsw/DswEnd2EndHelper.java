...
public class DswEnd2EndHelper{
  ...
  public DswEnd2EndHelper(String sinkConfigFile, String sinkName, 
      String srcConfigFile, String[] sourceNames, SinkCallBackListener listener){
  ...
  private int getSourceIndex(String sourceName) {
    ...
    if(srcInt == null ) {
      throw new IllegalArgumentException("Source by name \"" +sourceName+
          "\" does not exist.");
    }
