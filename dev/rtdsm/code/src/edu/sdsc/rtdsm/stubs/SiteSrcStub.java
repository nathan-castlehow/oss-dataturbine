...
public class SiteSrcStub extends SrcFeedbackListener{
  ...
  public SiteSrcStub(String configFile, String sourceName, 
      SrcFeedbackListener feedbackListener){ 
      ...
      while(connected){
        ...
        for(int channel=0 ; channel < chnlIndex.size(); channel++) {
          ...
          for(int i=0;i<data.length;i++) {
            System.out.println("Sent|" + source.getName() + "/" +
                chnlNames.elementAt(channel) + "|" +
        ...
        System.out.println("Flushed|" + source.getName() + "|" +
  ...
  public static void main(String[] args){
    ...
    switch(args.length) {
      case 3:
        ...
        // Fall through to read the next two arguments
      case 2:
        configFile = args[0];
        sourceName = args[1];
        break;
      default:
        System.err.println("Usage: java stubs.SiteSrcStub " +
            "<srcConfig xml file> <source name> [feedback]");
        return;
    }
  ...
  public void receiveFeedback(String feedbackMsg, Date time) {
    ...
    System.out.println("Received some feedback at the end " + 
