 ...
 *   $RCSfile: SegmentPushArgsDialog.java,v $ 
 * 
 */
...
public class SegmentPushArgsDialog
    extends JDialog
    ...
    private SegmentPushArgsDialog() {} // for testing

    public SegmentPushArgsDialog(Frame root, ArchiveInterface archive,
            ArchiveSegmentInterface previousSeg)
    {
    ...
    private JPanel makeBox(JPanel row, JLabel statusLabel) {
        ...
        box.setBorder(BorderFactory.createEmptyBorder(4, 4, 4, 4)); // t,l,b,r
    ...
    private void updateButtons() {
        if (selectedSeg == null)
            segmentButton.setText(v.htmlRed("Set " + SEGMENT_ACTION));
        else
            segmentButton.setText("Reset " + SEGMENT_ACTION);
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (arg.equals(OK_ACTION)) {
            ...
            GetSegmentDialog sel = new GetSegmentDialog(
                "Select Segment to Send to RBNB",
                (ArchiveInterface)archive, (JFrame)root, selectedSeg);
            selectedSeg = sel.getSelectedSegment();
            setSegmentName();
        } else
            System.out.println("Missed an action = " + arg);
        updateGraphics();
    }
    ...
    private class TestFrame extends JFrame //implements ActionListener
    {
        public TestFrame() {
            super();
        }
        ...
        private void doTest() {
            ...
            if (a.getSegmentsArray().length < 0)
               seg = a.getSegmentsArray()[0];
        ...
        private void printTest(SegmentPushArgsDialog test) {
            ...
            System.out.print(";  Source/Channel: " + test.getSource()
                + "/" + test.getChannel());
            System.out.println("");
        }
    }
