  ...
  throws Exception {
    ...
    */
    if (precision == 0) {
      ...
      double iWorking = Utilities.round(working);
	...
	if (precision == 0) {
      ...
      if (precision > 0) {
        long   value = (long) Utilities.round
	  ((working - Math.floor(working))*Utilities.pow(10.,precision));
...
*/
  ...
  throws Exception {
	...
	(Math.abs(doubleI) <= Utilities.pow(10.,precision)))) {
