    ...
    extends com.rbnb.api.Address
{
    ...
    private static com.rbnb.compat.InetAddress localhost = null;
    private static String localhostName = null;
    private static java.util.Hashtable hostMap = new java.util.Hashtable();

    // Private fields:
    /**
     * the host <code>com.rbnb.compat.InetAddress</code>.
     * <p>
     *
     * @author Ian Brown
     *
     ...
     * @version 05/16/2001
     */
    private com.rbnb.compat.InetAddress host = null;
...

    ...
    {
	com.rbnb.compat.ServerSocket ss = (com.rbnb.compat.ServerSocket) serverSideI;
	com.rbnb.compat.Socket socket;
	com.rbnb.compat.InetAddress netAddr = null;
...

	...
	com.rbnb.compat.InetAddress addr = null;
	String upcase;
	Object mapped = null;
	if (lhost.equalsIgnoreCase("localhost") ||
	    ...
	    try {
		com.rbnb.compat.InetAddress[] addresses =
		    com.rbnb.compat.InetAddress.getAllByName(lhost);

		if ((addr = checkForQualifiedName(addresses)) != null) {
		    lhost = addr.getHostName();

		} else {
		    com.rbnb.compat.InetAddress addr1 =
			com.rbnb.compat.InetAddress.getByName
			(addresses[0].getHostAddress());
		    com.rbnb.compat.InetAddress[] addresses2;
		    for (int idx = 0; idx < addresses.length; ++idx) {
			addresses2 = com.rbnb.compat.InetAddress.getAllByName
	    ...
	    } catch (Exception e) { //java.io.IOException e) { //.UnknownHostException e) {
		hostMap.put(upcase,new String(lhost));
	    }

	} else if (mapped instanceof com.rbnb.compat.InetAddress) {
	    addr = (com.rbnb.compat.InetAddress) mapped;
	}
...

     ...
     *
     */
    private final static com.rbnb.compat.InetAddress checkForQualifiedName
	(com.rbnb.compat.InetAddress[] addressesI)
    {
	com.rbnb.compat.InetAddress addrR = null;
...

	...
	try {
	    if (connectionI instanceof com.rbnb.compat.ServerSocket) {
		com.rbnb.compat.ServerSocket sSocket =
		    (com.rbnb.compat.ServerSocket) connectionI;
		sSocket.close();
	    } else if (connectionI instanceof com.rbnb.compat.Socket) {
		com.rbnb.compat.Socket socket = (com.rbnb.compat.Socket) connectionI;
		try {
		...
		} catch (Exception e) { //java.lang.NoSuchMethodError e) {
		}
		socket.close();
	    }
	} catch (java.lang.Exception e) {
...

	...
	com.rbnb.compat.Socket socketR = (com.rbnb.compat.Socket)clientSideI;
...

	...
	throws java.io.IOException,
	       java.lang.InterruptedException
    {
	((com.rbnb.compat.Socket) clientSideI).close();
    }

    /**
     * Gets the host <code>com.rbnb.compat.InetAddress</code>.
     * <p>
     *
     * @author Ian Brown
     *
     * @return the host <code>com.rbnb.compat.InetAddress</code>.
     * @see #setHost(com.rbnb.compat.InetAddress)
     * @since V2.0
     * @version 05/22/2001
     */
     ...
     *
     */
    private final com.rbnb.compat.InetAddress getHost() {
	return (host);
    }

    /**
     * Gets the local host <code>com.rbnb.compat.InetAddress</code>
     * <p>
     *
     * @author Ian Brown
     *
     * @return the local host <code>com.rbnb.compat.InetAddress</code>.
     * @since V2.0
     * @version 12/17/2002
     */
     ...
     *
     */
    final static com.rbnb.compat.InetAddress getLocalHost() {
	if (localhost == null) {
	    // If the local host has not been set yet, try to figure out what
	    // to use.
	    try {
		localhost = com.rbnb.compat.InetAddress.getLocalHost();
		if ((localhostName =
...

    ...
    {
	com.rbnb.compat.Socket socketR = null;
...

	...
	return (new com.rbnb.compat.ServerSocket(getPort(),backlog));
    }

    /**
	...
	if (addressI != null) {
		...
		Object mapped = null;
				...
				(upcase = hostName.toUpperCase())) == null) 
			{
				...
				// com.rbnb.compat.InetAddress.
				try 
				{
					addr = com.rbnb.compat.InetAddress.getByName(hostName);
			...
			else /* extra test, because the mapped version is a string */
			{
				addr = new com.rbnb.compat.InetAddress(hostName);
			}
...

    /**
     * Sets the host <code>com.rbnb.compat.InetAddress</code>.
     * <p>
     *
     * @author Ian Brown
     *
     * @param hostI  the host <code>com.rbnb.compat.InetAddress</code>.
     * @see #getHost()
     * @since V2.0
     * @version 05/22/2001
     */
     ...
     *
     */
    private final void setHost(com.rbnb.compat.InetAddress hostI) {
	host = hostI;
    }

    /**
...

     ...
     *
     */
    final static void setup(com.rbnb.compat.Socket socketI)
	throws java.io.IOException
    {
	...
	} catch (java.lang.Exception e) { //NoSuchMethodError e) {
	}
	try {
...

	 ...
	 * @version 04/27/2004
	 */
	private com.rbnb.compat.Socket socket = null;
...

	 ...
	 *
	 * @return the socket.
	 * @see #setSocket(com.rbnb.compat.Socket socketI)
	 * @since V2.2.3
	 * @version 04/27/2004
	 */
	 ...
	 *
	 */
	public final com.rbnb.compat.Socket getSocket() {
	    return (socket);
	}

	/**
...

	...
	public final void run() {
	    try {
		com.rbnb.compat.Socket lSocket = new com.rbnb.compat.Socket(getHost(),
							      getPort());
		setSocket(lSocket);
...

	 ...
	 *
	 */
	public final synchronized void setSocket(com.rbnb.compat.Socket socketI) {
	    socket = socketI;
	    notifyAll();
	}

...

	 ...
	 *
	 */
	public final synchronized com.rbnb.compat.Socket waitForSocket(long timeOutI)
	    throws com.rbnb.api.AddressException,
		   java.io.IOException,
		   java.lang.SecurityException
	{
