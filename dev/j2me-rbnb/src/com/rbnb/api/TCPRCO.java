    ...
    extends com.rbnb.api.SerializingRCO
{
     ...
     * @version 05/15/2001
     */
    private com.rbnb.compat.Socket dataSocket = null;

    /**
     * Class constructor.
     * <p>
...

	...
	com.rbnb.compat.Socket socket = (com.rbnb.compat.Socket) getServerSide();
	if (socket != null) {
	    setSerialize
...

	...
	com.rbnb.compat.Socket socket = (com.rbnb.compat.Socket) rcoI.getServerSide();
...

     ...
     *
     */
    final void attachDataSocket(com.rbnb.compat.Socket dataSocketI)
...

	...
	try {
		...
		com.rbnb.compat.Socket lsocket = (com.rbnb.compat.Socket) getServerSide();
		com.rbnb.compat.InetAddress laddress = lsocket.getLocalAddress();
...

     ...
     *
     */
    private final com.rbnb.compat.Socket getDataSocket() {
	return (dataSocket);
    }

    /**
...

	...
	com.rbnb.compat.Socket cSocket = (com.rbnb.compat.Socket) getServerSide();
	setSerialize
...

     ...
     *
     */
    final void setDataSocket(com.rbnb.compat.Socket dataSocketI) {
