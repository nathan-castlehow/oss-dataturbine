...

	...
	java.util.Vector lAwaiting = (java.util.Vector) com.rbnb.compat.Utilities.cloneVector(awaiting);
	...
	{
		super.cloned(o);
		RemoteClient clonedR = (RemoteClient)o;
		clonedR.awaiting = awaiting;
		clonedR.inStop = inStop;
		clonedR.message = message;
		clonedR.owner = owner;
		clonedR.receiver = receiver;
		clonedR.remoteName = remoteName;
		clonedR.rHandler = rHandler;
		clonedR.sink = sink;
		clonedR.startThread = startThread;
		clonedR.stopThread = stopThread;
