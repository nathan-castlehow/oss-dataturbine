...

	...
	protected void cloned(Object o)
	{
		super.cloned(o);
		NBO clonedR = (NBO)o;
		clonedR.asynchronousDoor = asynchronousDoor;
		clonedR.checkStream = checkStream;
		clonedR.nextRSVP = nextRSVP;
		clonedR.numberOfRequests = numberOfRequests;
		clonedR.remoteClients = remoteClients;
		clonedR.ro = ro;
		clonedR.srh = srh;
		clonedR.sri = sri;
		clonedR.unansweredRSVPs = unansweredRSVPs;
	}
}
