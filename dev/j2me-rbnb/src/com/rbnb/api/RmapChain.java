...

     ...
     */
    public Object clone() {
	RmapChain clonedR = new RmapChain();
	cloned(clonedR);
/*
	try {
	    //clonedR = (RmapChain) super.clone();  no clone??
		return null;
	...
	protected void cloned(Object o)
	{
		...
		RmapChain clonedR = (RmapChain)o;
		clonedR.havePayload = havePayload;
		if (getRmaps() != null) 
		{
			clonedR.rmaps = (java.util.Vector) com.rbnb.compat.Utilities.cloneVector(getRmaps());
		}
	}
