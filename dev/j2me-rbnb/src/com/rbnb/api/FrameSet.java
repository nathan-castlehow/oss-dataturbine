...
try{Thread.currentThread().sleep(1);}catch(Exception e){}
	...
	{
		FrameSet clonedR = (FrameSet)o;
		clonedR.filesetParent = filesetParent;
		clonedR.dataOffset = dataOffset;
		clonedR.headerOffset = headerOffset;
		clonedR.lastRegistrationIndex = lastRegistrationIndex;
		clonedR.regDataOffset = regDataOffset;
		clonedR.regHeaderOffset = regHeaderOffset;
		clonedR.da = da;
