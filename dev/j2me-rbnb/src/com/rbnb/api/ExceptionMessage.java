...

	...
	{
		ExceptionMessage clonedR = (ExceptionMessage)o;
		clonedR.exceptionClass = exceptionClass;
		clonedR.detailMessage = detailMessage;
	}

    /**
...

	...
	try {
		...
		// there is no reflection in j2me
...

	...
	try {
		...
		java.io.PrintStream pw = new java.io.PrintStream(baos);

	    // Write the exception out to the print writer stream.
	    //e.printStackTrace(pw);
		pw.print(e.toString()); // can't print the stacktrace to the string
	    pw.flush();
