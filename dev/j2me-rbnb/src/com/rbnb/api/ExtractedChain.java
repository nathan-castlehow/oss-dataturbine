...

	...
	clonedR = new ExtractedChain(extractor, request);
		cloned(clonedR);
...

	...
	{
		ExtractedChain clonedR = (ExtractedChain)o;
		clonedR.delayRequest = delayRequest;
		clonedR.needFrameMatch = needFrameMatch;
		clonedR.needTimeMatch = needTimeMatch;
		clonedR.inherited = inherited;
		clonedR.request = request;
		clonedR.requestChain = requestChain;
		clonedR.extractor = extractor;
		clonedR.fRange = fRange;
		clonedR.tRange = tRange;
	}	
}
