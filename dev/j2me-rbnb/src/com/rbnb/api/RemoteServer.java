	       ...
	       com.rbnb.api.RoutedTarget
{
	...
	final Object metricsSyncObj = new Object() {}; //java.io.Serializable() {};
	...
	if (offsetI == -1) {
		...
		if ((lPath != null) &&
			...
			targetName = targetName.substring
			    (com.rbnb.compat.Utilities.lastIndexOf(myName, "/"));
...

	...
	{
		super.cloned(o);
		RemoteServer clonedR = (RemoteServer)o;
		clonedR.awaiting = awaiting;
		clonedR.connected = connected;
		clonedR.pathFindCounter = pathFindCounter;
		clonedR.metricsDeadBytes = metricsDeadBytes;
		clonedR.remoteClientCount = remoteClientCount;
	}
}
