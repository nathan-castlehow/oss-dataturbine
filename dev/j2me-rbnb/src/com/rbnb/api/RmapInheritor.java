...

	...
	try {
		...
		clonedR = new RmapInheritor();
	} catch (Exception e) {//CloneNotSupportedException e) {
	    return (null);
	}
		clonedR.dataFlag = dataFlag;
		clonedR.wantData = wantData;
		clonedR.missingMask = missingMask;
		clonedR.payload = payload;
		clonedR.timeValues = timeValues;

	clonedR.setRmaps((java.util.Vector) com.rbnb.compat.Utilities.cloneVector(getRmaps()));
