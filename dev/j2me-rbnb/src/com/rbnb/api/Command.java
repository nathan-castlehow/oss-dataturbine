...
import com.rbnb.compat.InternalError;
...

     ...
     */
    public Object clone() {
	Command clonedR = null; // super.clone();  abstract, will be overwritten anyways
...

	...
	className = className.substring
	    (Utilities.lastIndexOf(className, ".") + 1);
