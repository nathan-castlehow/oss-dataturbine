...

     ...
     */
    public Object clone() {
	// create a new object and then set it up with the right members
	Rmap clonedR = new Rmap(); //(Rmap) super.clone();
	cloned(clonedR);
/*
	try {
	    if (clonedR != null) {
...
*/
	...
	protected void cloned(Object o)
	{
		...
		*/
		Rmap clonedR = (Rmap)o;
		clonedR.dataBlock = dataBlock;
		clonedR.parent = parent;
		clonedR.children = children;
		clonedR.groupList = groupList;
		clonedR.name = name;
		clonedR.frameRange = frameRange;
		clonedR.nameNSD = nameNSD;
		clonedR.timeRange = timeRange;
		try 
		{
			if (clonedR != null) 
			{
...

	...
	try {
		...
		(com.rbnb.compat.Utilities.lastIndexOf(className, ".") + 1);
