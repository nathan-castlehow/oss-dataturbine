...

	...
	public WaitForRouters(ConnectedServer cServerI) {
	    super();
	    //setDaemon(true);  cannot do this in j2me
	    cServer = cServerI;
	}

	/**
	...
	{
		super.cloned(o);
		ConnectedServer clonedR = (ConnectedServer)o;
		clonedR.availableRouters = availableRouters;
		clonedR.local = local;
		clonedR.nextRouterId = nextRouterId;
		clonedR.relatedRouters = relatedRouters;
