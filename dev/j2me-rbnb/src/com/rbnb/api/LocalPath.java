...

	...
	setOrdered((java.util.Vector) com.rbnb.compat.Utilities.cloneVector(lPathI.getOrdered()));
	try {
...

    ...
    final Path toPath() {
	Path pathR = new Path();
	pathR.setOrdered(com.rbnb.compat.Utilities.cloneVector((java.util.Vector) getOrdered()));
	return (pathR);
    }

    /**
	...
	public Object clone()
	{
		LocalPath clonedR = new LocalPath();
		cloned(clonedR);
		clonedR.cost = cost;
		return clonedR;
	}
