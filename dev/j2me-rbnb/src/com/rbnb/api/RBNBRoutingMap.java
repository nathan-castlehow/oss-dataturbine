...

	...
	{
		super.cloned(o);
		RBNBRoutingMap clonedR = (RBNBRoutingMap)o;
		clonedR.awaiting = awaiting;
		clonedR.localServerHandler = localServerHandler;
		clonedR.metricsDeadBytes = metricsDeadBytes;
		clonedR.peerDoor = peerDoor;
		clonedR.peerUpdates = peerUpdates;
