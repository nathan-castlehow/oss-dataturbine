...

	...
	public Object clone()
	{
		Object o = new RemoteClientHandler();
		cloned(o);
		return o;
	}
	...
	{
		super.cloned(o);
		RemoteClientHandler clonedR = (RemoteClientHandler)o;
		clonedR.started = started;
		clonedR.aRequest = aRequest;
		clonedR.rMessage = rMessage;
		clonedR.serverHandler = serverHandler;
		clonedR.sink = sink;
