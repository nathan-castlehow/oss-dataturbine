...
public final class Directory {
     ...
     * @version 03/10/2003
     */
    private com.rbnb.compat.File directory = null;

    /**
     * Class constructor.
     * <p>
...

     ...
     *
     */
    public Directory(com.rbnb.compat.File directoryI) {
	this();
...

     ...
     *
     */
    public final com.rbnb.compat.File[] listFiles()
	throws java.io.IOException
    {
	com.rbnb.compat.File[] filesR = null;
...

     ...
     *
     */
    private final com.rbnb.compat.File[] listFilesFromNames()
	throws java.io.IOException
    {
	com.rbnb.compat.File[] filesR = null;
	...
	if (files != null) {
	    filesR = new com.rbnb.compat.File[files.length];

	    for (int idx = 0; idx < files.length; ++idx) {
		filesR[idx] = new com.rbnb.compat.File(directory,files[idx]);
	    }
	}
