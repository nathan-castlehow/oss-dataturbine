...

	...
	*/
	...
	//rStop.setDaemon(true);  can't do this in j2me
	rStop.start();
    }

    /**
...

	...
	{
		super.cloned(o);
		RouterHandle clonedR = (RouterHandle)o;
		clonedR.buildDate = buildDate;
		clonedR.buildVersion = buildVersion;
		clonedR.lastWriteTime = lastWriteTime;
		clonedR.pingTask = pingTask;
		clonedR.pingValue = pingValue;
