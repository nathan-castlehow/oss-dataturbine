...

	...
	setShortcuts
	    ((com.rbnb.utility.SortedVector) com.rbnb.compat.Utilities.cloneVector(peerI.getShortcuts()));
    }

    /**
...

	...
	public Object clone()
	{
		PeerUpdate clonedR = new PeerUpdate();
		clonedR.peerAddress = peerAddress;
		clonedR.peerName = peerName;
		clonedR.peerUpdateCounter = peerUpdateCounter;
