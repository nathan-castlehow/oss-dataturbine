...
//try {Thread.currentThread().sleep(10000);}catch(Exception e){}
	...
	} catch (java.io.IOException e) { //com.rbnb.compat.SocketException e) {//java.net.SocketException e) {
	    if (e.getMessage() == null) {
		throw e;
...

	...
	protected void cloned(Object o)
	{
		...
		SerializingACO clonedR = (SerializingACO)o;
		clonedR.lastReceived = lastReceived;
		clonedR.lastTransmitted = lastTransmitted;
		clonedR.serialize = serialize;
	}
}
