...

	...
	if (getTerminateRequested()) {
		...
		com.rbnb.compat.Utilities.cloneVector((java.util.Vector) getChildren());
	    for (int idx = 0;
...

	...
	java.util.Vector list = com.rbnb.compat.Utilities.cloneVector((java.util.Vector) getChildren());
