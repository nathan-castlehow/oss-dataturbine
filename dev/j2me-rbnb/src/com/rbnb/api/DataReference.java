...

    ...
    public final Object clone() {
		DataReference clonedR = new DataReference();
		clonedR.indivisibleFlag = indivisibleFlag;
		clonedR.wordOrder = wordOrder;
		clonedR.dataType = dataType;
		clonedR.mimeType = mimeType;
		clonedR.offset = offset;
		clonedR.stride = stride;
		return clonedR;
	//return (super.clone());
    }

