...
public abstract class Serializable
	implements com.rbnb.compat.Cloneable
/* j2me doesn't support serializable
...

	...
	try {
		// no clone here, so just create a new version of this
		// problem with this is that it won't save the attributes, so overwrite down the line
	    //clonedR = (Serializable) super.clone();
		//clonedR = new Serializable();
	//} catch (java.lang.CloneNotSupportedException e) {
	} catch (java.lang.Exception e) {

	}
		throw new RuntimeException(this.getClass() + " must overwrite the clone method in J2ME");
