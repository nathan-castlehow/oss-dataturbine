...

	...
	javax.microedition.io.HttpConnection connector = (javax.microedition.io.HttpConnection)javax.microedition.io.Connector.open(authFile);
/*
...
//	}
	...
	java.io.DataInputStream isRead = connector.openDataInputStream();
	String word = "",
	       token;
	...
	try {
		...
		// Read each line of the authorization file.
			...
			currentChar = isRead.readChar();
			while(currentChar != '\r' && currentChar != ' ' && currentChar != '\n')
			{
				word += currentChar;
			}
