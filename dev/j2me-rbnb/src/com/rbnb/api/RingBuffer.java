...

	...
	{
		super.cloned(o);
		RingBuffer clonedR = (RingBuffer)o;
		clonedR.acceptingAFrame = acceptingAFrame;
		clonedR.addingAFrame = addingAFrame;
		clonedR.archive = archive;
		clonedR.awaiting = awaiting;
		clonedR.bad = bad;
		clonedR.cache = cache;
		clonedR.cleanupError = cleanupError;
		clonedR.fatalError = fatalError;
		clonedR.frame = frame;
		clonedR.full = full;
		clonedR.hasChanged = hasChanged;
		clonedR.idIndex = idIndex;
		clonedR.lastFrameSummary = lastFrameSummary;
		clonedR.lastRegistration = lastRegistration;
		clonedR.lastRegistrationResult = lastRegistrationResult;
		clonedR.myNames = myNames;
		clonedR.registered = registered;
		clonedR.registrationDoor = registrationDoor;
		clonedR.terminateRequested = terminateRequested;
