...

	...
	{
		super.cloned(o);
		ShortcutIO clonedR = (ShortcutIO)o;
		clonedR.active = active;
		clonedR.cost = cost;
		clonedR.destinationAddress = destinationAddress;
		clonedR.destinationName = destinationName;
	}
}
