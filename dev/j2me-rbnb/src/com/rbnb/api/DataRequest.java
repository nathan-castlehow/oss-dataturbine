...

	...
	public Object clone()
	{
		Object clonedR = new DataRequest();
		cloned(clonedR);
		return clonedR;
	}
	...
	{
		super.cloned(o);
		DataRequest clonedR = (DataRequest)o;
		clonedR.gapControl = gapControl;
		clonedR.increment = increment;
		clonedR.repetitions = repetitions;
		clonedR.responseMode = responseMode;
		clonedR.synchronizedChannels = synchronizedChannels;
		clonedR.timeDomain = timeDomain;
		clonedR.timeReference = timeReference;
		clonedR.timeRelationship = timeRelationship;
