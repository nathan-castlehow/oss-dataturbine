...
public class ChannelListVisitor implements ExpressionVisitor
{
	...
	public boolean[] getChannelList() { return list; }
	...
	private void setChannel(int index)
	{
		...
		{  // reallocate array
			...
			for (int i = 0; i < list.length; i++)
				more[i] = list[i];
			for (int i = list.length; i < more.length; i++)
				more[i] = false;
			list = more;
		}
		list[index] = true;
	...
	public Object visit(SimpleNode node, Object data) { return process(node, data); }
	...
	public Object visit(MySpecial node, Object data) { return data; }
	public Object visit(MyLit node, Object data) { return data; }
	...
	public Object visit(MyLogicalValue node, Object data) { return data; }
