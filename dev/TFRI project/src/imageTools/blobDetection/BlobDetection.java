	...
	computeEdgeVertex(iBlob, x,y);
	{
	 ...
	 else  
	 {
		...
		if (filterBlobMethod != null)
        {
        	try 
			{
        		boolean returnValue = filterBlobMethod.newBlobDetectedEvent( blob[iBlob] );
...
// activeCustomFilter
//--------------------------------------------
public void activeCustomFilter(BlobListener filterBlob)
{
	  this.filterBlobMethod = filterBlob;
