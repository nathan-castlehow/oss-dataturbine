...
public class Util {
	public static void loadBankIntoRBNB(ImageBank<AnnotatedImage> bank, int cacheSize,
			int archiveSize, String rbnbHostName, String srcName) throws IOException, SAPIException{
