...
public class GenericDataSourceLight {
	...
	private Source source;							//Source to write to
	 ...
	 */
	public GenericDataSourceLight(	String srcName, String serverPath, int port,
	 ...
	 */
	public GenericDataSourceLight(	String srcName, String serverPath, int port,
			int cacheSize, int archiveSize, String archiveMode)	 throws SAPIException {
