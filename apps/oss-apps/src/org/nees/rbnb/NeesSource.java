	...
	// emualtes an extension -- extends Source
{
	 ...
	 */
	public NeesSource(int cacheSize, String archiveMode, int archiveSize)
	{
...
// Depricated methods of client, for referance
//	public void CloseRBNBConnection (boolean keepCache, boolean keepArchive)
//		{source.CloseRBNBConnection(keepCache,keepArchive);} 
//	public String [] GetChannelList () throws SAPIException
//		{return source.GetChannelList();}
//	public String [] GetChannelList (String matchStr) throws SAPIException
//		{return source.GetChannelList(matchStr);}	
